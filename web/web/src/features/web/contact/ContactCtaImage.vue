<template>
  ...
  >
    ...
    >
      <div
        class="flex flex-col items-center justify-center w-full max-w-lg lg:max-w-none lg:w-[35vw]"
      >
        <h3
          class="font-display text-3xl sm:text-4xl lg:text-5xl font-bold text-white! leading-tight"
        >
          OD PODKLADU AŽ PO POSLEDNÚ LIŠTU — VŠETKO NA
          <span class="text-dark"> JEDNOM </span>MIESTE.
        </h3>
        <div class="mt-6 flex flex-wrap justify-center gap-3">
          <BaseButton variant="primary" to="/kontakt"
            >Dohodnite si meranie</BaseButton
          >
          <BaseButton variant="soft" href="tel:+421444323884"
            >Zavolajte nám</BaseButton
          >
        </div>
      </div>
    </div>
